                            ...
                            <div className="mobile-inner">
                                        ...
                                        <div className="mobile-nav"> 
                                                 <ul ref={linksWrap}>
                                                           ...
                                                           <li onMouseOver={() => setDropdown(true)} onMouseOut={() => setDropdown(false)} className={dropdown ? "special list-item" : 'list-item'}><NavLink className={dropdown ? 'active' : ''} to={'/products/'}>Products  <span><LiaAngleDownSolid /></span></NavLink>
